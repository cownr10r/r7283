...
#' @return Produces .xml files with concatenated metadata and machine readable text, and a quality control message indicating parsimony between indexed file names. Note well: Due to inconsistent text tagging from file sources originating from JSTOR, may throw error messages when processing. At point of issuance, this code originates from a problem in education research practice setting.
